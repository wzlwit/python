...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # * create variable for single, favorite type of movie. (Property)
        self.favorite = StringVar()
        self.favorite.set(None)

        # all the 3 buttons share the same variable
        # * create Comedy radio button. And associate it's 'Value'
        Radiobutton(self,
                    text="Comedy",
