...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.pw_lbl.grid(row=1, column=0, sticky=W)  # sticky to the WEST
        ...
        # wrap = WORD, CHAR and NONE
        self.secret_txt = Text(self, width=35, height=5, wrap=WORD)
        self.secret_txt.grid(row=3, column=0, columnspan=2, sticky=W)

    def reveal(self):
        """ Display message based on password. """
        contents = self.pw_ent.get()    # returns the text in Entry or Text
        if contents == "secret":
        ...
        self.secret_txt.delete(0.0, END)    # 0.0 : Row 0 and Col 0
        self.secret_txt.insert(0.0, message)    # no replace method
